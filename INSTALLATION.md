...
The plugin manifest is hosted on GitHub. You'll need the raw URL:
```
https://raw.githubusercontent.com/YOUR_USERNAME/seanime-dub-preference/main/manifest.json
```

Replace `YOUR_USERNAME` with your GitHub username (or use the original repo URL once published).
